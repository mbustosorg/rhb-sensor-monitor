...
MAG_MEDIANTABLESIZE = (
    9  # Median filter table size for magnetometer. Higher = smoother but a longer delay
)
...
def IMU_state():
    ...
    result = {}
    result["acc"] = {"x": AccXangle, "y": AccYangle}
    result["gyro"] = {"x": gyroXangle, "y": gyroYangle, "z": gyroZangle}
    result["comp"] = {"x": CFangleX, "y": CFangleY}
    result["heading"] = {
        "heading": heading,
        "tiltCompensatedHeading": tiltCompensatedHeading,
    }
    result["kalman"] = {"x": kalmanX, "y": kalmanY}
